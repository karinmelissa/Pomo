...
ScrollReveal().reveal('.informaciones', { delay: 500 });
ScrollReveal().reveal('.people', { delay: 500 });
ScrollReveal().reveal('.invite', { delay: 500 });
...
function onPomodoroTimer(){
  ...
  gSeconds = 0;
  resetTimer();
  $('#shortButton').removeClass('success');
  $('#longButton').removeClass('success');
  $('#pomodoroButton').addClass('pomo-success');
}
...
function onShortTimer(){
  ...
  gSeconds = 0;
  resetTimer();
  $('#pomodoroButton').removeClass('pomo-success');
  $('#longButton').removeClass('success');
  $('#shortButton').addClass('success');
}
